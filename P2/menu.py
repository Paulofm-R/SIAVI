...
buttons = {
    1: {"label": "Pong", "script": './Pong/pong_menu.py', "pos": (100, 100), "size": (200, 100)},
    2: {"label": "Jogo do Galo", "script": './JogoGalo/jogoGalo_menu.py', "pos": (350, 100), "size": (200, 100)},
    3: {"label": "Quatro em Linha", "script": './QuatroLinha/main.py', "pos": (600, 100), "size": (200, 100)}
}
