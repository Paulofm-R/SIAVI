...
buttons = {
    ...
    2: {"label": "1 Jogador", "script": './JogoGalo/jogoGalo_single.py', "pos": (350, 100), "size": (200, 100)},
    3: {"label": "2 Jogadores", "script": './JogoGalo/jogoGalo_multy.py', "pos": (600, 100), "size": (200, 100)}
}
...
with mp_hands.Hands(
    ...
    while True:
        ...
        cv.imshow('Menu - Jogo do Galo', frame)
